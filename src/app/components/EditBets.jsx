...
const OddsTimeline = (props) => {
    ...
    for (let i = 0; i < changes.length; i++) {
        ...
        if (
            change["arena"] === arenaId &&
            change["pirate"] === pirateIndex + 1
        ) {
                            ...
                            <Box>
                                ...
                                >
                                    ...
                                    <Box>
                                        ...
                                        <Text as="i">
                                            {pirateName} opened at {openingOdds}
                                            :1
                                        </Text>
                                    </Box>
                                </Flex>
                ...
                <Tr>
                    {ARENA_NAMES.map((arenaName, arenaId) => {
                        return (
                            <Th key={arenaId}>
                                {arenaName} (
                                {displayAsPercent(arenaRatios[arenaId], 1)})
                            </Th>
                        );
                    })}
                    <Th>
