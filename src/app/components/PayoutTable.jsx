        ...
        <>
            ...
            {[...Array(amountOfBets)].map((e, betIndex) => {
              ...
              return (
                <Tr key={betIndex}>
                        ...
                        <>
                          ...
                          <HStack spacing="1px">
                            ...
                            <IconButton
                              ...
                              icon={<ArrowDownIcon />}
                              onClick={() =>
                                swapBets(betIndex + 1, betIndex + 2)
                              }
                  ...
                  <Td isNumeric>{betPayoffs[betIndex + 1].toLocaleString()}</Td>
                  <Td isNumeric>
                    <TextTooltip
                  ...
                  {[...Array(5)].map((e, arenaIndex) => {
                    let pirateIndex =
                      allBets[currentBet][betIndex + 1][arenaIndex];
                    let bgColor = "transparent";
                    if (pirateIndex) {
                      if (winningBetBinary) {
                        const pirateBin = computePirateBinary(
                          arenaIndex,
                          pirateIndex
                        );
                        ...
                        bgColor = getPirateBgColor(
                          roundState.roundData.openingOdds[arenaIndex][
                            pirateIndex
                          ]
                        );
                      }
                    ...
                    return (
                      <Td key={arenaIndex} backgroundColor={bgColor}>
                        {
                          PIRATE_NAMES[
                            roundState.roundData.pirates[arenaIndex][
                              pirateIndex - 1
                            ]
                          ]
                        }
          ...
          <Tbody>
            <Tr>
              ...
              <Th isNumeric>
                {winningBetBinary > 0 && (
                  <Text>{totalWinningPayoff.toLocaleString()}</Text>
                )}
              </Th>
              <Th />
              <Th isNumeric>
