...
import { getTableMode, reducer, parseBetUrl, calculateRoundData, getUseWebDomain, getUseLogitModel, anyBetsExist, cloneArray } from "./util";
...
const StateProvider = ({ children }) => {
	...
	const [calculations, setCalculations] = useState(
		calculateRoundData(roundState, allBets[currentBet], allBetAmounts[currentBet])
	);
